...
The harmonic landscape of Figure~\ref{fig:harmonics} is not merely a
...
The harmonic landscape of exp\_09 (Figure~\ref{fig:harmonics}) is the
...
prediction.
It can be measured from the harmonic landscape (Figure~\ref{fig:harmonics})
...
The harmonic landscape of Figure~\ref{fig:harmonics} is the
