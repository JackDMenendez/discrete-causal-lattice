...
performs it is\\
\nolinkurl{src/utilities/induced_gauge_action.py},
and its captured output is\\
\nolinkurl{data/induced_gauge_action.txt}.
...
\begin{figure}[h]
\centering
\input{../figures/induced_action_ellipsoid}
\end{figure}
