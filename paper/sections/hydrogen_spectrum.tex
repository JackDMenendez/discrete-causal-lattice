...
one.  A controlled three-arm operator comparison (\texttt{exp\_20},
planned) replacing the as-written drain with the unitary beam splitter
and per-session normalisation with joint enforcement is the next
implementation step.
