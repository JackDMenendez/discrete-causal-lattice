...
A full lattice derivation of the Hawking temperature
$T_H = \hbar c / (8\pi G M k_B)$ from the queue-drop rate is left to
future work; the present claim is structural.
Hawking radiation is what an architecturally bounded scheduler does
when it is asked to do more than it can.
