...
The frame condition verified in Section~\ref{subsec:dirac_limit} gives
\begin{equation}
    M_{ij} = \sum_{\mathbf{v}\in\text{RGB}} v_i v_j = 3\,\delta_{ij},
    \label{eq:frame}
\end{equation}
so the quadratic term simplifies to $-\tfrac{1}{2}|\mathbf{k}|^2$.
