\includegraphics[width=\textwidth]{../figures/Diamond_Grid_Units_drawio.png}
\caption{Fundamental length and momentum scales of the $T^3_\text{diamond}$
lattice.
\textbf{Hop distance.}
...
$\delta x = \sqrt{3}$;\ $c = 1$;\ $\delta x \cdot \delta p = \hbar\pi$;\
$R_1 \cdot k_\text{Bohr} = 1$;\ $\omega \cdot R_1 = \pi/3$ (dynamical).}
